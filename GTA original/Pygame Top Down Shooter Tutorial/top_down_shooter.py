...
#load image
background = pygame.transform.scale(pygame.image.load("images/background.png").convert(), (WIDTH, HEIGHT))
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.rotozoom(pygame.image.load("images/0.png").convert_alpha(), 0, PLAYER_SIZE)
